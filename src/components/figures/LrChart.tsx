...
// curve; hover reports tokens, step, cluster and the learning rate.
...
const SPEC: ChartSpec = {
  ...
  traces: piecewiseTraces({
    ...
    hovertemplate: (label) =>
      `<b>%{customdata[0]:.3f}T tokens</b><br><b>cluster</b>: ${label}<br><b>step</b>: %{customdata[1]}<br><b>learning rate</b>: %{customdata[2]}<extra></extra>`,
    width: 2,
  }),
  layout: {
    showlegend: false,
